...
//        System.out.println("r: " + r + " theta: " + theta);
        return new Complex(Math.pow(r, p)*Math.cos(theta*p), Math.pow(r, p)*Math.sin(theta*p));
    }
    public Complex invertRI(){
        return new Complex(im,re);
    }
//    public void round(){
//        re = (double) Math.round(re * 100000) / 100000;
//        im = (double) Math.round(im * 100000) / 100000;
//    }
